...
class FrontController
{
    static function main()
    {
        ...
        require 'libs/Conexion.php'; //PDO con singleton
        require 'libs/View.php'; //Mini motor de plantillas
 
        require 'controllers/configController.php'; //Archivo con configuraciones.
        ...
        {
            trigger_error ('Clase->funcion no existe: '.$controllerName . '->' . $actionName . ' no existe', E_USER_NOTICE);
            return false;
        }
